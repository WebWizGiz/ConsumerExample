...
public class UnaryOperatorExample {
    public static void main(String[] args) {
         ...
         * however, we are interested in the first count '5' numbers:
        ...
        SequenceGenerator generator1 = new SequenceGenerator(stepSize);
        int sum1 = generator.generateAndSum(start, count);

        System.out.println("The sum of the generated sequence: " + sum1);
